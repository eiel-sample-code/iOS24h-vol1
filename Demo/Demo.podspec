...
Pod::Spec.new do |s|
  ...
  #
  s.source   = { :git => 'http://EXAMPLE/Demo.git', :tag => '1.0.0' }
  # s.source   = { :svn => 'http://EXAMPLE/Demo/tags/1.0.0' }
  # s.source   = { :hg  => 'http://EXAMPLE/Demo', :revision => '1.0.0' }

  s.description = 'An optional longer description of Demo.'
